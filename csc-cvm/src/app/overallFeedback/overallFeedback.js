angular.module('cvm.overallFeedback', [])
    .config(function config($stateProvider) {
        $stateProvider.state('overallFeedback', {
            url: '/overallFeedback',
            views: {
                "main": {
                    controller: 'overallFeedbackCtrl',
                    templateUrl: 'overallFeedback/overallFeedback.tpl.html'
                }
            },
            data: {
                pageTitle: 'Overall Feedback'
            }
        });
    })
    .controller('overallFeedbackCtrl', function($scope, commonService, $timeout, $interval, $state) {
